...
class MyHandler(BaseHTTPRequestHandler):
    ...
    def do_POST(self):
        ...
        if path == "/display.html":
            ...
            # lambda for magnitude of a 2D vector
            phylib_length = lambda list_vals: math.sqrt(list_vals[0]*list_vals[0] + list_vals[1] * list_vals[1])
            ...
            rolling_ball_speed = phylib_length([rolling_ball_dx, rolling_ball_dy])
